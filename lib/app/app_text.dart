...
class AppText {
  ...
  String get location =>
      isThai ? 'พื้นที่/สวน (ไม่บังคับ)' : 'Location (Optional)';
  ...
  String get optionalLocationNote => isThai
      ? 'พื้นที่/สวนสามารถเว้นว่างได้ และระบุภายหลังในไฟล์ CSV/Excel ของงานวิจัย'
      : 'Location can be left blank and completed later in the research CSV/Excel file';
