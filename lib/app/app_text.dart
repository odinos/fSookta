...
class AppText {
  ...
  String get roleFarmer => isThai ? 'ชาวสวน' : 'Farmer';
  String get roleStaff => isThai ? 'เจ้าหน้าที่' : 'Research staff';
  String get location =>
      isThai ? 'พื้นที่ทำงาน (ไม่บังคับ)' : 'Work Space (Optional)';
  String get participantCodeHint => isThai
      ? 'ระบบสร้างรหัสให้ ไม่ต้องทราบล่วงหน้า'
      : 'Generated by the app; no prior code is required';
  String get optionalLocationNote => isThai
      ? 'พื้นที่ทำงานสามารถเว้นว่างได้ และระบุภายหลังในไฟล์ CSV/Excel ของงานวิจัย'
      : 'Work space can be left blank and completed later in the research CSV/Excel file';
