...
class AppText {
  ...
  String get selectLanguage => isThai
      ? 'กรุณาเลือกภาษาเพื่อเริ่มต้นใช้งาน'
      : 'Please select language to start';
  ...
  String get avatarSubtitle => isThai
      ? 'เลือกรูปแทนตัว หรือถ่ายภาพของคุณ'
      : 'Choose an avatar or take a photo';
  String get avatarHint =>
      isThai ? 'เลือกจากรายการด้านล่าง' : 'Select from the list below';
  String get confirmAvatar =>
      isThai ? 'ยืนยันรูปโปรไฟล์' : 'Confirm Profile Picture';
  ...
  String get startEvaluation =>
      isThai ? 'เริ่มทำแบบประเมิน' : 'Start Evaluation';
  String get riskAssessment => isThai ? 'ประเมินความเสี่ยง' : 'Risk Assessment';
  String get noHistory =>
      isThai ? 'ยังไม่มีประวัติการประเมิน' : 'No assessment history yet';
