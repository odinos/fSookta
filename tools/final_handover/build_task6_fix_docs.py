...
ROOT=Path('/private/tmp/fsookta-final-handover'); A=ROOT/'artifacts'
...
def uat_report():
 ...
 for x in P['historical_uat']:
  ...
  table(d,['Dimension','Source-exact metadata'],[['Device',x['device']],['Runner / harness',x['runner_harness']],['Build workaround',x['build_workaround']],['Assessment bypass',x['assessment_bypass']],['Blocker',x['blocker']],['Observation',x['observation']],['Evidence',x['evidence_path']],['SHA-256',x['sha256']],['Layer',x['evidence_layer']]],[1.55,4.95],8)
